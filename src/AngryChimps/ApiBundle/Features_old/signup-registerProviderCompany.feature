Feature: signup-registerProviderCompany
  ...
  Scenario: Signup a new user
    ...
    And The response contains a field named "payload.provider_ad.id"
    And The value of the "payload.provider_ad.id" field returned is of type "string"
    And The string length of the "payload.provider_ad.id" field is "32"
