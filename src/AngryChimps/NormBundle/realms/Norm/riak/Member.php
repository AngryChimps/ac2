...
//        return $member;
    ...
    protected function createHook($realm, $tableName, $fieldData, $primaryKeys, $autoIncrementFieldName) {
        ...
        // Add autoincrement id to riak blob
        $this->mysqlId = $mysqlMember->mysqlId;

        parent::createHook($realm, $tableName, $fieldData, $primaryKeys, $autoIncrementFieldName);
...
//        $bucket->put($obj);
    ...
    {
        $mysqlMember = \Norm\mysql\Member::getById($this->id);
        $mysqlMember->delete();

        return parent::deleteHook($realm, $tableName, $primaryKeys); // TODO: Change the autogenerated stub
    }
