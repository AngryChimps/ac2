...
class CompanyPhotosBase extends NormBaseObject {
    ...
    /** @var string[] */
    protected static $fieldNames = array('company_id', 'photos');

    /** @var string[] */
    protected static $fieldTypes = array('string', 'string[]');

    /** @var  string[] */
    protected static $propertyNames = array('companyId', 'photos');
