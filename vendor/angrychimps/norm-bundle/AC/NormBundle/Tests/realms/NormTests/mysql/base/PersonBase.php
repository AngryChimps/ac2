...
class PersonBase extends NormBaseObject {
    ...
    /** @var string[] */
    public static $fieldNames = array('id', 'father_id', 'mother_id', 'address_id');

    /** @var string[] */
    public static $fieldTypes = array('int', 'int', 'int', 'int');

    /** @var  string[] */
    public static $propertyNames = array('id', 'fatherId', 'motherId', 'addressId');
